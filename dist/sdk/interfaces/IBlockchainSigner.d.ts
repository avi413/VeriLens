...
export interface IBlockchainSigner {
     ...
     */
    signPayload(payload: ArrayBuffer | Uint8Array | string, chainId: string): Promise<SignatureResult>;
    /**
     * Submit the signed payload to the network and return a receipt placeholder.
     */
    submitTransaction(signature: SignatureResult, options?: Record<string, unknown>): Promise<TransactionReceipt>;
    /**
     * Poll the blockchain for an updated receipt.
     */
    getTransactionReceipt(txHash: string, chainId: string): Promise<TransactionReceipt>;
}
